...
/obj/item/clothing/head/helmet/space/plasmaman/captain
	...
	desc = "A special containment helmet designed for the Captain.\
		Embarrassingly enough, it looks way too much like the Head of Personnel's design save for the gold stripes. I mean, come on. Gold stripes can fix anything."
